/**
 * Una clase abstract en Typescript es una clase que no se puede crear instancia
 * y que puede contener propiedades o métodos abstractos que deben ser implementados en la
 * subclases (Interfase). También puede tener propiedades o métodos que tengan ya una implementación
